...
.Plugin-Empty {
  & .Plugin-EmptyBubble:nth-child(2) {
    ...
    transform: translate(-50%, -50%) scale(0.45) skewX(5deg);
  }
  ...
  & .Plugin-EmptyBubble:nth-child(3) {
    ...
    transform: translate(-50%, -50%) scale(0.15) skewX(5deg);
  }
  ...
  & .Plugin-EmptyBubble:nth-child(4) {
    ...
    transform: translate(-50%, -50%) scale(0.35) skewX(12deg);
  }
  ...
  & .Plugin-EmptyBubble:nth-child(5) {
    ...
    transform: translate(-50%, -50%) scale(0.5) skewX(4deg);
  }
  ...
  & .Plugin-EmptyBubble:nth-child(6) {
    ...
    transform: translate(-50%, -50%) scale(0.25) skewX(16deg);
  }
  ...
  .Plugin-EmptyBubble {
    ...
    filter: opacity(0.5) brightness(120%);
    box-shadow: 0 0 8px #00000011;
    transform: translate(-50%, -50%);
...
@keyframes bubble {
  ...
  100% {
    opacity: 0;
    transform: translate(-50%, -50%) scale(0.75) skewX(16deg);
  }
}
