import { ITouchPlugin, IPluginFeature } from '@talex-touch/utils/plugin';
import path from 'path';
import { coreBoxManager } from '../box-tool/core-box/manager';

export class PluginViewLoader {
  public static async loadPluginView(plugin: ITouchPlugin, feature: IPluginFeature): Promise<void | null> {
